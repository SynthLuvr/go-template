...
// The tool block is the entire toolchain surface: one meta-tool
// (go-canon), the task runner, and the tools go-canon drives. Versions
...
require (
	...
	github.com/SynthLuvlr/go-canon v0.1.0 // indirect
